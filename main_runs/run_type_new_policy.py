...
class QBucket:
    ...
    def bucket_partitioning(self, low_index, high_index, sorted_res):
        ...
        for i in range(low_index, high_index+1):
            ...
            p2 = 1-p1
            #expected consumption that is lower than or equal to delim
            ...
            #expected consumption that is greater than delim
            if n2 == 0:
                exp_cons_g_delim = 0
            else:
            ...
            delim_cost = p1*exp_cons_lq_delim + p2*exp_cons_g_delim
